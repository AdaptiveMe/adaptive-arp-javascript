/// <reference path="AccelerationBridge.d.ts" />
/// <reference path="AdsBridge.d.ts" />
/// <reference path="AlarmBridge.d.ts" />
/// <reference path="AmbientLightBridge.d.ts" />
/// <reference path="AnalyticsBridge.d.ts" />
/// <reference path="AudioBridge.d.ts" />
/// <reference path="BarcodeBridge.d.ts" />
/// <reference path="BarometerBridge.d.ts" />
/// <reference path="BluetoothBridge.d.ts" />
/// <reference path="BrowserBridge.d.ts" />
/// <reference path="CalendarBridge.d.ts" />
/// <reference path="CameraBridge.d.ts" />
/// <reference path="CapabilitiesBridge.d.ts" />
/// <reference path="CloudBridge.d.ts" />
/// <reference path="CommonUtil.d.ts" />
/// <reference path="CompressionBridge.d.ts" />
/// <reference path="ConcurrentBridge.d.ts" />
/// <reference path="ContactBridge.d.ts" />
/// <reference path="CryptoBridge.d.ts" />
/// <reference path="DataStreamBridge.d.ts" />
/// <reference path="DatabaseBridge.d.ts" />
/// <reference path="DesktopBridge.d.ts" />
/// <reference path="DeviceBridge.d.ts" />
/// <reference path="DisplayBridge.d.ts" />
/// <reference path="FacebookBridge.d.ts" />
/// <reference path="FileBridge.d.ts" />
/// <reference path="FileSystemBridge.d.ts" />
/// <reference path="GeolocationBridge.d.ts" />
/// <reference path="GlobalizationBridge.d.ts" />
/// <reference path="GooglePlusBridge.d.ts" />
/// <reference path="GyroscopeBridge.d.ts" />
...
/// <reference path="IAppRegistry.d.ts" />
...
/// <reference path="ImagingBridge.d.ts" />
/// <reference path="InternalStorageBridge.d.ts" />
/// <reference path="LifecycleBridge.d.ts" />
/// <reference path="LinkedInBridge.d.ts" />
/// <reference path="LoggingBridge.d.ts" />
/// <reference path="MagnetometerBridge.d.ts" />
/// <reference path="MailBridge.d.ts" />
/// <reference path="ManagementBridge.d.ts" />
/// <reference path="MapBridge.d.ts" />
/// <reference path="MessagingBridge.d.ts" />
/// <reference path="NFCBridge.d.ts" />
/// <reference path="NetworkInfoBridge.d.ts" />
/// <reference path="NetworkNamingBridge.d.ts" />
/// <reference path="NetworkReachabilityBridge.d.ts" />
/// <reference path="NetworkStatusBridge.d.ts" />
/// <reference path="NotificationBridge.d.ts" />
/// <reference path="NotificationLocalBridge.d.ts" />
/// <reference path="OAuthBridge.d.ts" />
/// <reference path="OCRBridge.d.ts" />
/// <reference path="OSBridge.d.ts" />
/// <reference path="OpenIdBridge.d.ts" />
/// <reference path="PrintingBridge.d.ts" />
/// <reference path="ProximityBridge.d.ts" />
/// <reference path="QRCodeBridge.d.ts" />
/// <reference path="RSSBridge.d.ts" />
/// <reference path="RuntimeBridge.d.ts" />
/// <reference path="SecurityBridge.d.ts" />
/// <reference path="ServiceBridge.d.ts" />
/// <reference path="SettingsBridge.d.ts" />
/// <reference path="SocketBridge.d.ts" />
/// <reference path="StoreBridge.d.ts" />
/// <reference path="TelephonyBridge.d.ts" />
/// <reference path="TimerBridge.d.ts" />
/// <reference path="TwitterBridge.d.ts" />
/// <reference path="UIBridge.d.ts" />
/// <reference path="UpdateBridge.d.ts" />
/// <reference path="VibrationBridge.d.ts" />
/// <reference path="VideoBridge.d.ts" />
/// <reference path="WalletBridge.d.ts" />
/// <reference path="XMLBridge.d.ts" />
/**
